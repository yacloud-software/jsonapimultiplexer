...
require (
	...
	golang.conradwood.net/apis/autodeployer v1.1.2910 // indirect
	golang.conradwood.net/apis/deploymonkey v1.1.2910 // indirect
	golang.conradwood.net/apis/echoservice v1.1.2878 // indirect
	golang.conradwood.net/apis/errorlogger v1.1.2878 // indirect
	golang.conradwood.net/apis/framework v1.1.2910 // indirect
	golang.conradwood.net/apis/goeasyops v1.1.2910 // indirect
	golang.conradwood.net/apis/grafanadata v1.1.2910 // indirect
	golang.conradwood.net/apis/objectstore v1.1.2910 // indirect
	golang.conradwood.net/apis/registry v1.1.2910 // indirect
	golang.org/x/sys v0.19.0 // indirect
	golang.org/x/text v0.14.0 // indirect
	golang.yacloud.eu/apis/autodeployer2 v1.1.2897 // indirect
	golang.yacloud.eu/apis/fscache v1.1.2910 // indirect
	golang.yacloud.eu/apis/jsonapidoc v1.1.2910 // indirect
